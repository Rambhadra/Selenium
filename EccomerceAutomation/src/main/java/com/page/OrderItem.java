...
import com.actions.OrderItemActions;

public class OrderItem extends OrderItemActions{
	WebDriver driver;
...
//		driver.manage().timeouts().implicitlyWait(40, TimeUnit.SECONDS);
		...
		sendDataToInput(getLoadedElement(driver,emailInputLogin), "tiwariji99565@gmail.com");
		sendDataToInput(getLoadedElement(driver,passInputLogin), "umeshtiwari");
		stop(300);
